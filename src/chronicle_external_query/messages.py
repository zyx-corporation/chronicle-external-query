...
CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "cli.fixtures.success": "Fixture registry loaded successfully.",
        "cli.fixtures.failure": "Fixture registry loading failed.",
        "cli.plugins.success": "Provider plugin registry loaded successfully.",
        "cli.plugins.failure": "Provider plugin registry loading failed.",
        "cli.plugin_doctor.success": "Provider plugin diagnostic completed successfully.",
        "cli.plugin_doctor.failure": "Provider plugin diagnostic failed.",
        "cli.compare_query_runs.success": "Comparative query evaluation completed successfully.",
        "cli.compare_query_runs.failure": "Comparative query evaluation failed.",
